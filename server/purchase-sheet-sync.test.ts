...
describe("purchase sheet sync helpers", () => {
  it("builds a sheet row with normalized blank-safe values", () => {
    ...
    ).toEqual(["PO-1", "綠途未來", "智慧型手機", "", "SN-1", "", "", "2026/04/22 18:30", "Yana", "2026/04/22 19:43", "Leo", "2026/04/22 20:08", "88, 電池異常", "正常", "Mia", "2026/04/22 21:15", "N", "破裂", "刮傷"]);
  });
  ...
  it("formats Date objects for the sheet using YYYY/MM/DD HH:mm", () => {
    ...
    ).toEqual(["PO-2", "綠途未來", "平板", "BATCH-2", "SN-2", "IMEI-2", "iPad mini", "2026/04/22 09:05", "Amy", "2026/04/22 10:43", "Ben", "2026/04/22 11:15", "75, 電池異常", "觸控異常", "Cody", "2026/04/22 13:05", "Y", "破裂", "刮傷"]);
  });
  ...
  it("fills only blank cells and preserves non-empty sheet values except H 到 O 欄由系統刷新", () => {
    const existingRow = ["PO-1", "綠途未來", "智慧型手機", "", "SN-1", "IMEI-1", "現場已填品名", "舊的 A1 時間", "舊的 A1 執行人", "舊的 A2 時間", "舊的 A2 執行人", "舊的 B 時間", "舊的電池資訊", "舊的故障資訊", "舊的 B 執行人", "舊的 C 時間", "舊的上一關修改標記", "舊的螢幕狀態", "舊的機身狀態"];
    const generatedRow = ["PO-1", "綠途未來", "智慧型手機", "BATCH-1", "SN-1", "IMEI-1", "iPhone 13", "2026/04/22 18:30", "Yana", "2026/04/22 19:43", "Leo", "2026/04/22 20:08", "88, 電池異常", "正常", "Mia", "2026/04/22 21:15", "N", "正常", "正常"];
  ...
  it("creates the standard header row when the sheet is still empty", () => {
    expect(PURCHASE_SHEET_HEADER).toEqual(["採購單號", "廠商", "商品分類", "商品批號", "商品序號", "IMEI", "品名", "點到貨時間", "A1執行人", "安裝軟體時間", "A2執行人", "軟體測試時間", "電池檢測", "B站故障狀態", "B站執行人", "測試時間", "是否修改B站的狀態回覆", "螢幕狀態", "機身狀態"]);
